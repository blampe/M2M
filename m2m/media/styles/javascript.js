...
function visToggle(source,id,textReplace){
	source = document.getElementById(source);
	textReplace = textReplace || ['Less...','More...'];
	var seeMe = document.getElementById(id).style.visibility;
